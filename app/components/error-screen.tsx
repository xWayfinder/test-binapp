      ...
      <div className="w-full max-w-md">
        <Card className="shadow-lg border-0">
          <CardHeader className="text-center pb-4">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-destructive/20 rounded-full mb-4 mx-auto">
          ...
          <CardContent className="text-center space-y-4">
            ...
            <Button onClick={onTryAgain} className="w-full h-12 text-base bg-primary hover:bg-primary/90">
